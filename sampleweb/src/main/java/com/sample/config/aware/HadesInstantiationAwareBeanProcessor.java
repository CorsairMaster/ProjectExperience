 ...
 * @Version 1.0
 */
public class HadesInstantiationAwareBeanProcessor extends BeanNameAutoProxyCreator implements BeanFactoryPostProcessor {

	private List<String> MAPPER_BEAN_LIST = new CopyOnWriteArrayList();

	private boolean initDone = false;

	public HadesInstantiationAwareBeanProcessor() {
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		...
		for (int i = 0; i < beanDefinitionNamesLength; ++i) {
			...
			if (beanDefinition.getFactoryMethodName() != null && beanDefinition.getFactoryMethodName()
					.equals("redisOpsUtil")) {
